...
class ConvNet(nn.Module):
    def __init__(self, k_size,stride,pad):
        ...
        self.conv7 = nn.Sequential(
            nn.Conv1d(25,8,  k_size, 1, padding=pad),
            nn.ReLU(),
            nn.BatchNorm1d(8))
#         self.conv8 = nn.Sequential(
#             nn.Conv1d(25,8,  k_size, stride, padding=pad),
#             nn.ReLU(),
#             nn.BatchNorm1d(8))
...
#             nn.BatchNorm1d(100*63))
        ...
        self.deconv7 = nn.Sequential(
            nn.Conv1d(8,25,  k_size, 1, padding=pad),
            nn.ReLU(),
            nn.BatchNorm1d(25))
    ...
    #               ##########
            ...
            if train_ds % 10 ==0:
                ...
                if args.testing: 
                    ...
                    test_loss, test_acc, conf_matrix, N_term,C_term = Test.get_performance(
                                        model, criterion, confusion_matrix = True, pos_acc=True)
                    ...
                    Test.plot_pos_acc(N_term, C_term)
